...
from macports.")
 ...
 '(initsplit-customizations-alist (quote (("\\`\\(org\\|calendar\\|diary\\)-" "org-settings.el" nil nil) ("\\`\\(wl\\|apel\\|flim\\|semi\\|mime\\|mm\\)-" "wl-settings.el" nil nil) ("\\`yas/" "yasnippet-settings.el" nil nil))))
