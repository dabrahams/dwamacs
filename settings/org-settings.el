...
")
 ...
 '(org-modules
   (quote
    (org-crypt org-id org-habit org-mac-message org-bookmark org-eval)))
 '(org-refile-targets
   (quote
 ...
 '(org-stuck-projects
   (quote
    ("+LEVEL=1/-DONE"
     ("TODO" "STARTED" "NEXT" "NEXTACTION")
     nil "\\(Appointments\\|Notes\\|Anniversaries\\)")))
 '(org-tag-alist
   (quote
    ((#("LUANN" 0 5
        (face nil))
...
(custom-set-faces
 ...
 '(org-mode-line-clock
   ((t
     (:inherit variable-pitch :background "green" :foreground "black" :box
