...
Added -h so I can read file sizes")
 '(dwa/el-get-standard-packages (quote ("markdown-mode" "php-mode" "psvn" "nognus" "org-mode" "apel" "elscreen" "yasnippet" "gravatar" "wl-gravatar" "filladapt" "emacs-w3m" "elhome" "byte-code-cache" "el-get" "browse-kill-ring" "magit" "semi" "flim" "wanderlust" "el-get" "initsplit")))
