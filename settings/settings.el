...
Added -h so I can read file sizes")
 '(dwa/el-get-standard-packages (quote ("maxframe" "markdown-mode" "php-mode" "psvn" "nognus" "org-mode" "apel" "elscreen" "yasnippet" "gravatar" "wl-gravatar" "filladapt" "emacs-w3m" "elhome" "byte-code-cache" "el-get" "browse-kill-ring" "magit" "semi" "flim" "wanderlust" "el-get" "initsplit")))
...
from macports.")
 ...
 '(initsplit-customizations-alist (quote (("\\`\\(org\\|calendar\\|diary\\)-" "org-settings.el" nil nil) ("\\`\\(wl\\|apel\\|flim\\|semi\\|mime\\|mm\\|elmo\\)-" "wl-settings.el" nil nil) ("\\`yas/" "yasnippet-settings.el" nil nil))))
...
(custom-set-faces
 ...
 '(elscreen-tab-background-face ((((class color)) (:background "lightgray" :height 1.0 :family "Helvetica"))))
