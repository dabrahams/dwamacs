...
Added -h so I can read file sizes")
 '(dwa/el-get-standard-packages (quote ("elhome" "byte-code-cache" "el-get" "browse-kill-ring" "magit" "semi" "flim" "apel" "wanderlust" "el-get" "initsplit")))
...
from macports.")
 ...
 '(initsplit-customizations-alist (quote (("\\`\\(org\\|calendar\\|diary\\)-" "org-settings.el" nil nil))))
